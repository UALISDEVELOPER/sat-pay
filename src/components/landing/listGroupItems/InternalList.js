...
export const organizationalCreditList = [
    {
        key : 1,
...
export const socialSecurityList = [
    {
        key : 1,
        name : "اطلاعات کاربر",
        link : "/pishkhan/not-available"
...
export const billAndChargeList = [
    {
        key : 1,
        name : "استعلام قبوض",
        link : "/pishkhan/not-available"
